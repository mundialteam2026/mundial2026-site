      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        <div className="bg-white/5 rounded-2xl p-8">
          <div className="flex items-center gap-6 mb-8">
            ...
            <div>
              <h2 className="text-3xl font-bold">{j.nom}</h2>
              <p className="text-[#FBBF24] text-lg">{j.pays} · {j.poste}</p>
              <p className="text-white/50">{j.equipe}</p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            <div className="bg-white/10 rounded-xl p-4 text-center">
              <p className="text-3xl font-bold text-[#FBBF24]">{j.buts}</p>
              <p className="text-white/50 mt-1">Buts</p>
            </div>
            <div className="bg-white/10 rounded-xl p-4 text-center">
              <p className="text-3xl font-bold text-[#FBBF24]">{j.passes}</p>
              <p className="text-white/50 mt-1">Passes</p>
            </div>
            <div className="bg-white/10 rounded-xl p-4 text-center">
              <p className="text-3xl font-bold text-[#FBBF24]">{j.cartons_jaunes}</p>
              <p className="text-white/50 mt-1">Cartons jaunes</p>
            </div>
            <div className="bg-white/10 rounded-xl p-4 text-center">
              <p className="text-3xl font-bold text-[#FBBF24]">{j.minutes_jouees}</p>
